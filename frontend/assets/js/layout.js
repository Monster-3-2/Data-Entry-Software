      ...
      <a class="sidebar-logo" href="/dashboard.html">
        <div class="logo-mark">
          <svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <!-- Wheels -->
            <circle cx="6" cy="16" r="2" stroke="rgba(255,255,255,0.9)"/>
            <circle cx="18" cy="16" r="2" stroke="rgba(255,255,255,0.9)"/>
            <!-- Thermometer stem -->
            <line x1="15" y1="3" x2="15" y2="11"/>
            <!-- Thermometer bulb -->
            <circle cx="15" cy="12" r="1.5" fill="rgba(255,180,80,0.9)" stroke="rgba(255,180,80,0.9)"/>
            <!-- Thermometer outline -->
            <rect x="13.5" y="2" width="3" height="9" rx="1.5" stroke="rgba(255,255,255,0.9)"/>
            <!-- Mercury level -->
            <line x1="15" y1="10" x2="15" y2="6" stroke="rgba(255,180,80,0.9)" stroke-width="1.5"/>
          </svg>
        </div>
        <div class="logo-text">
